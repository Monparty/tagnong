# Tagnong Code — Design System (Claymorphism)
...
```
ออกแบบ UI ของแอป "Tagnong Code" — ระบบ QR code ติดปลอกคอสัตว์เลี้ยง เมื่อสัตว์หาย คนที่เจอสแกน QR แล้วแจ้งเจ้าของพร้อมตำแหน่ง GPS ได้
